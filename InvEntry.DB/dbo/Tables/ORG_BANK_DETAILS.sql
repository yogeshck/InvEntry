...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'True/  False', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'ORG_BANK_DETAILS', @level2type = N'COLUMN', @level2name = N'ONLINE_ENABLED';
